...
Killington is the largest ski area in the Eastern United States by most measures — trail count, skiable acreage, and vertical drop. It is roughly twice the size of most other Vermont resorts. The closest comparison in terms of scale would be [Sunday River](/ski/sunday-river) or [Sugarloaf](/ski/sugarloaf) in Maine, but neither matches Killington's vertical or peak count. That said, bigger is not always better — some skiers prefer the intimacy of smaller mountains like Mad River Glen or [Sugarbush](/ski/sugarbush).
